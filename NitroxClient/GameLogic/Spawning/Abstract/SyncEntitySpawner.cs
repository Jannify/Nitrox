...
public abstract class SyncEntitySpawner<T> : EntitySpawner<T>, ISyncEntitySpawner where T : Entity
{
    ...
    /// <returns>The result of <see cref="SpawnSync(T,TaskResult{NitroxModel.DataStructures.Util.Optional{UnityEngine.GameObject}})"/> or true with the caught exception </returns>
